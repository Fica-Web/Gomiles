  ...
  return (
    ...
    <div className="space-y-6 ">
        ...
        {selectedPackage.itinerary && selectedPackage.itinerary.map((day, index) => (
            <div key={index} className="space-y-2  border-2 rounded-2xl p-2 transition duration-300 transform hover:scale-105 hover:border-golden pb-4">
                <h3 className="font-Aceh-Light sm:text-xl lg:text-base xl:text-lg">
                    <span className='font-Bevas text-lg uppercase sm:text-xl font-bold lg:text-lg xl:text-2xl'>Day {day.day}:</span> {day.title}
                </h3>
                <p className="font-Aceh-Light text-lg">
                <span className='font-Bevas text-lg uppercase sm:text-xl font-bold lg:text-lg xl:text-2xl'> Location:</span> {day.details.place}
                </p>
                <p className="font-Aceh-Light text-lg">
                <span className='font-Bevas text-lg uppercase sm:text-xl font-bold lg:text-lg xl:text-2xl'> Meals:</span> {day.details.meals}
                </p>
